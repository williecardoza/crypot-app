  ...
  return (
    <>
      ...
      <PriceContainer>
        <FlexContainer>
          <H1>
            {formatCurrency(data.market_data.current_price[currency], currency)}
          </H1>
          <StyledArrowIcon />
          <ProfitValue>
        ...
        <FlexContainer>
          <ValueContainer>
            <H3>
              Profit:{" "}
              <ProfitValue value={parseInt(data.market_data.price_change_24h)}>
      ...
      <MarketDataContainer>
        <FlexContainer>
          ...
          <H3>
            Market Cap:{" "}
            <Span>
              {formatCurrency(data.market_data.market_cap[currency], currency)}
            </Span>{" "}
          </H3>
        </FlexContainer>
        ...
        <VolumeContainer>
          ...
          <FlexContainer>
            ...
            <H3>
              Circulating Supply:{" "}
              <Span>
                {formatCurrency(data.market_data.circulating_supply, currency)}
              </Span>
            </H3>
          </FlexContainer>
          <FlexContainer>
